...
```bash
node test/all.js       # 86 pruebas: reglamento, sistemas y motor
...
- **Motor** (19): invariantes del partido (nadie sale del campo, la posesión
...
Terminado y jugable de principio a fin, con 86 pruebas automáticas en verde.
