...
```bash
node test/all.js       # 87 pruebas: reglamento, sistemas y motor
...
- **Motor** (20): invariantes del partido (nadie sale del campo, la posesión
...
Terminado y jugable de principio a fin, con 87 pruebas automáticas en verde.
