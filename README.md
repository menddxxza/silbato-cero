...
```bash
node test/all.js       # 91 pruebas: reglamento, sistemas y motor
...
- **Motor** (24): invariantes del partido (nadie sale del campo, la posesión
...
Terminado y jugable de principio a fin, con 91 pruebas automáticas en verde.
