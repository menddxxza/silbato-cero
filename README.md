...
```bash
node test/all.js       # 92 pruebas: reglamento, sistemas y motor
...
- **Motor** (25): invariantes del partido (nadie sale del campo, la posesión
...
Terminado y jugable de principio a fin, con 92 pruebas automáticas en verde.
